...
% --- Định nghĩa màu sắc ---
\definecolor{mainblue}{RGB}{70,80,190}
...
% --- Cấu hình Footer (Bo tròn & Thông tin động) ---
...
\title{\textbf{LÝ THUYẾT ĐỒ THỊ}}
\subtitle{Graph Theory}
\author{Tác giả: Khôi Nguyên}
\date{\today}
...
\begin{columns}
    ...
    \begin{column}{0.5\textwidth}
        ...
        \begin{tikzpicture}[
            ...
            path_style/.style={draw, pathgreen, ultra thick, -{Stealth[length=3mm, width=2mm]}}, % Mũi tên đẹp hơn
            ...
            \draw[path_style] (A) to node[midway, above left, pos=0.3, pathgreen]{\tiny 3} (Y);
            \draw[path_style] (Y) to node[midway, below right, pos=0.7, pathgreen]{\tiny 4} (Z);
            \draw[path_style] (Z) to node[midway, above, pos=0.5, pathgreen]{\tiny 3} (B);
